...
## Cap without trade
```{r}
# stringency = 455/755 = 0.602
# baseline*0.602 = abatement
# P* using the new Q* based on abatement
kern_p_drought <- {kern_slope*(kern_baseline-59.7)}
mojave_p_drought <- {mojave_slope*(mojave_baseline-55.72)}
antelope_p_drought <- {antelope_slope*(antelope_baseline-87.56)}
ventura_p_drought <- {ventura_slope*(ventura_baseline-97.51)}
...
# calculate area of triangle using 1/2(P*)(change in Q) to get individual costs
kern_cost_drought <- 0.5*(kern_p_drought)*(59.7)
mojave_cost_drought <- 0.5*(mojave_p_drought)*(84.28)
antelope_cost_drought <- 0.5*(antelope_p_drought)*(132.44)
ventura_cost_drought <- 0.5*(ventura_p_drought)*(147.49)
